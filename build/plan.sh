pkg_name=threatstack-to-wavefront
pkg_description='Record Threat Stack alerts as events in Wavefront'
pkg_version=0.1.0
pkg_origin=tmclaugh
pkg_maintainer='Tom McLaughlin'
pkg_license=('MIT')
pkg_upstream_url='https://github.com/threatstack/threatstack-to-wavefront'
